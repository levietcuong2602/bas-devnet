...
var devNetConfig = genesisConfig{
	...
	Validators: []common.Address{
		common.HexToAddress("0x3b40a5561aa410ab7e4ca2990730cc58f204dcd4"),
		common.HexToAddress("0x39891be2458c220c1260f3acb0f2bbd5318ddb45"),
		common.HexToAddress("0x33b199e11850afced36535d69b59072bde152673"),
	},
	SystemTreasury: map[common.Address]uint16{
	...
	InitialStakes: map[common.Address]string{
		common.HexToAddress("0x3b40a5561aa410ab7e4ca2990730cc58f204dcd4"): "0x3635c9adc5dea00000", // 1000 eth
		common.HexToAddress("0x39891be2458c220c1260f3acb0f2bbd5318ddb45"): "0x3635c9adc5dea00000", // 1000 eth
		common.HexToAddress("0x33b199e11850afced36535d69b59072bde152673"): "0x3635c9adc5dea00000", // 1000 eth
	},
	// owner of the governance
	...
	Faucet: map[common.Address]string{
		...
		common.HexToAddress("0xf2b6d1f1b74ab116a56ceb01bf48c40e33836950"): "0x52b7d2dcc80cd2e4000000", // faucet (10kk)
	},
}
